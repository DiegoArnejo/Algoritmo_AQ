...
El algoritmo analiza una serie de atributos para generar una regla conceptual que identifique una clase objetivo (en este caso, la predisposición a adquirir un automóvil eléctrico o ).
